...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void storePasswordHint() {
        ...
        // Log.d(TAG, "storePasswordHint: " + passwordHint.getText().toString());
        Map<String, Object> hint = new HashMap<>();
        hint.put("hints", passwordHint.getText().toString());
        ...
        db.collection("hints").document(email.getText().toString())
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.d(TAG, "storePasswordHint Success: " + passwordHint.getText().toString());
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.d(TAG, "storePasswordHint Success: " + e);
                    }
                });
    }
